        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-danger position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">ToYourBelly</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        {(!localStorage.getItem("token")) ?
                            ...
                            <div>
                                ...
                                <div className="btn text-danger bg-white text-success mx-2 " onClick={loadCart}>
                                ...
                                <button onClick={handleLogout} className="btn text-danger bg-white text-success" >Logout</button></div>}
                    </div>
                </div>
            </nav>
        </div>
